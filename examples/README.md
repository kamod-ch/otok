...
CI validates reference apps with `pnpm check:examples` and the Cloudflare example with `pnpm smoke:cloudflare` (pack local packages, typecheck, build, `wrangler deploy --dry-run`).
